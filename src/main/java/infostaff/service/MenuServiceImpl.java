...
public class MenuServiceImpl implements IMenuService {
	...
	@Override
	public List<MenuModel> getMenuNotAssignedByRole(User user) {
		...
		List<TblMenuEntity> entities = menuRepo.findMenusNotByRoleNameAndParentId(roleName, parentMenuCode);
		...
		for (TblMenuEntity entity : entities) {
			...
			mainMenuModel = menuMapping.entityToModel(entity);
			// get sub menu
			List<TblMenuEntity> subEntities = menuRepo.findMenusNotByRoleNameAndParentId(roleName, entity.getMenuId());
